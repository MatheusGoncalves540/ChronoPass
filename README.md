...
para o uso diário — por padrão os dados ficam só no aparelho. Lojas que ativam a
integração opcional com o SummusBackoffice (ver [`SUMUS-INTEGRACAO.md`](SUMUS-INTEGRACAO.md))
enviam ponto e cadastro para lá e recebem de volta cadastro, loja e correções de ponto —
sem perder nada do que já foi registrado no aparelho.
...
- [`SUMUS-INTEGRACAO.md`](SUMUS-INTEGRACAO.md) — sincronização com o SummusBackoffice (contrato técnico): **implementada e testada**, nos dois sentidos — o app envia ponto/cadastro e recebe de volta cadastro, loja e correções de ponto.
...
- **Sincroniza sob demanda** — com o SummusBackoffice configurado, ponto e cadastro sobem e cadastro/loja/correções de ponto descem; nenhuma marcação já gravada no aparelho se perde no processo.
